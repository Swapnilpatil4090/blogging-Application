            ...
            customUI: ({ onClose }) => {
              return (
                <div className='shadow p-3 mb-5 mx-auto bg-white rounded text-center'>
                  <h1 className='mx-5'>Confirm to Update ?</h1> <hr />
                  <p className='mx-5' >Are you sure you want to update this Post?
                    </p>
                    ...
                    <CardBody>
                        ...
                        <Form onSubmit={updatePost} >
                            ...
                            <Container className="text-center">
                                <Button outline type="submit" className="rounded-1 shadow" color="primary">Update  Post</Button>
                                <Button outline className="rounded-1 ms-2 shadow  " type='reset' onClick={cancelHandle} color="danger">Cancel Update</Button>
                            </Container>
